...
$(document).ready(function(){
		...
		var showLoader = (typeof show_loader === 'undefined' ? true : show_loader);
		...
		if( showLoader ){	
			...
			$(document).ajaxStop(function(){ hideLoading(); setLightbox(); });
			$(window).hashchange();
			//keepAlive();
		}
   ...
   //Mantem uma sessão ativa
	...
	function automation( obj ){
		...
		$(".button.background, .buttom.background", $(obj)).click(function(evt){
		...
		$(".date", $(obj)).mask("99/99/9999").datepicker({ dateFormat: "dd/mm/yy" });
		$(".datetime", $(obj)).mask("99/99/9999 99:99").datepicker({ dateFormat: "dd/mm/yy 00:00" });
		$(".mask-fone", $(obj)).mask("(99) 9999-9999?9",{placeholder:" "});
		$(".mask").each(function(){
